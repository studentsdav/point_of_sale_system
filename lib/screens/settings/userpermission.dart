...
class _UserPermissionFormState extends State<UserPermissionForm> {
  ...
  void _savePermissionsToDatabase(outlet) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Permissions saved to database successfully')),
      );
    } catch (error) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('User Permission Configuration')),
              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Select Permissions for each User',
                        style: TextStyle(
                            fontSize: 16, fontWeight: FontWeight.bold)),
                          ...
                          Row(
                            children: [
                              ElevatedButton(
                                ...
                                child: const Text('Assign All Permissions'),
                              ),
                            ],
                          ),
