...
class _TableManagementPageState extends State<TableManagementPage> {
  ...
  Future<void> _saveTableEntry() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Failed to create table')));
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(labelText: 'Select Outlet'),
              validator: (value) {
            ...
            if (_selectedOutlet != null) ...[
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Vacant', 'Occupied', 'Dirty']
                    ...
                    .toList(),
                decoration: const InputDecoration(labelText: 'Table Status'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
